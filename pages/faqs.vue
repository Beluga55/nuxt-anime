...
<template>
  <div
    class="bg-[url('/assets/images/faq.jpg')] min-h-[35vh] flex items-center py-10 px-5 bg-cover bg-center max-w-[1024px] mx-auto"
    :class="[
      props.paddingFix,
      width >= 1024 ? 'mt-[6.5rem] rounded-3xl' : 'mt-[4.5rem]',
    ]"
  >
    <div class="w-full" :class="[width >= 1024 && 'px-10']">
  ...
  <Accordion
    type="single"
    class="w-full max-w-[1024px] mx-auto pt-[5rem]"
  ...
  <!-- Contact Form Action -->
  <div class="max-w-[1024px] mx-auto mt-20" :class="[props.paddingFix]">
    <div
      class="border-[1px] rounded-lg backdrop-filter-light border-border-color"
      :class="[width >= 680 && 'grid grid-cols-2 items-center']"
    >
      <img
        :src="liyue"
        alt="liyue"
        ...
        :class="[
          width >= 680
            ? 'rounded-tl-lg rounded-bl-lg h-full'
            : 'rounded-tl-lg rounded-tr-lg',
        ]"
      />
      <form :class="[width >= 680 ? 'px-7 py-7' : 'px-5 py-5']">
        <div>
          <div>
