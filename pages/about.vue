...
<template>
  <div
    class="h-screen bg-[url('/assets/images/about-banner.png')] bg-cover bg-center relative"
  ...
  <div
    ref="goals"
    class="py-20 max-w-[1024px] mx-auto"
    :class="props.paddingFix"
  >
    <div class="grid">
    ...
    <div
      class="grid items-stretch gap-6 mt-10"
      :class="
        width > 768
          ? 'grid-cols-3'
          : width > 576
  ...
  <div class="py-20 max-w-[1024px] mx-auto" :class="props.paddingFix">
    <div class="grid items-center gap-6" :class="width > 900 && 'grid-cols-2'">
      <img
        :src="KeqingBanner"
        alt="Keqing"
        class="w-full h-[250px] object-cover object-center rounded-2xl"
        :class="width > 900 && 'h-[450px]'"
      />
